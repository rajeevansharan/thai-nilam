...
const AdminSidebar: React.FC<AdminSidebarProps> = ({
  ...
  return (
    <aside className="w-64 min-w-[256px] flex-shrink-0 bg-white border-r border-gray-100 hidden lg:flex flex-col p-6 space-y-2">
      ...
      <button
        ...
        className={`flex items-center gap-3 w-full px-4 py-3 rounded-lg text-sm font-semibold transition-all ${activeTab === "dashboard" ? "bg-[#0F172A] text-white shadow-xl" : "text-gray-500 hover:bg-gray-50"}`}
      >
      ...
      <button
        ...
        className={`flex items-center gap-3 w-full px-4 py-3 rounded-lg text-sm font-semibold transition-all ${activeTab === "issues" ? "bg-[#0F172A] text-white shadow-xl" : "text-gray-500 hover:bg-gray-50"}`}
      >
