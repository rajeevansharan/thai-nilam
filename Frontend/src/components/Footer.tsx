    ...
    <footer className="mt-20 py-10 px-8 md:px-20 bg-[#0F172A] text-white w-full border-t border-white/5">
      <div className="w-full flex flex-col md:flex-row items-center justify-between gap-10 md:gap-0">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left">
          <div className="text-xl md:text-2xl font-serif font-bold tracking-[0.1em] text-[#d4a017]">
            Thai Nilam
          </div>
          <p className="text-[9px] md:text-[10px] font-medium text-gray-500 uppercase tracking-[0.2em] mt-1">
