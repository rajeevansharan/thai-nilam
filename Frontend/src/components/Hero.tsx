...
const Hero: React.FC = () => {
  return (
    <div className="relative overflow-hidden bg-[#0a0d16] text-[#e2e8f0] py-20 px-4 md:px-16 flex flex-col md:flex-row items-center justify-between">
      {/* Background patterns */}
      <div className="absolute top-0 right-0 w-full h-full pointer-events-none opacity-20">
        <svg className="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
          <path d="M100 0 C 80 20, 60 40, 100 80" stroke="goldenrod" strokeWidth="0.5" fill="none" />
          <path d="M100 10 C 70 30, 50 60, 100 90" stroke="goldenrod" strokeWidth="0.5" fill="none" />
        </svg>
      </div>

      <div className="relative z-10 max-w-2xl text-left">
        <div className="flex items-center space-x-2 text-[10px] uppercase font-semibold tracking-[0.2em] text-[#c49a6c]">
        ...
        <div className="mt-12 flex flex-wrap gap-4">
          <button className="flex items-center gap-2 px-8 py-3.5 bg-[#d4a017] hover:bg-[#b8860b] text-[#0a0d16] font-semibold text-sm rounded shadow-lg transition-all transform hover:-translate-y-0.5">
            Unlock Issue
