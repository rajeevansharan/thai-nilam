      ...
      <div className="hidden lg:flex lg:w-3/5 bg-[#1e293b] flex-col items-center justify-center p-12 text-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-slate-400 text-lg md:text-xl font-light max-w-md leading-relaxed">
            Your gateway to premium stories, ideas, and perspectives — delivered monthly.
          </p>
        </div>
      ...
      <div className="w-full lg:w-2/5 bg-white flex flex-col justify-center px-8 sm:px-16 lg:px-24 py-12">
        <div className="max-w-md w-full mx-auto">
          <div className="mb-10 text-left">
            ...
            <p className="text-gray-500 text-sm">Sign in to access your purchased issues.</p>
          </div>

          {/* Demo Credentials Alert */}
          <div className="bg-amber-50/50 border border-amber-100 rounded-xl p-4 mb-8 text-left">
             <p className="text-[11px] uppercase font-bold tracking-widest text-amber-600 mb-2">Demo Credentials</p>
             <div className="space-y-1 text-sm font-medium text-gray-700">
                <p>Email: <span className="text-gray-900">reader@edition.com</span></p>
                <p>Password: <span className="text-gray-900">edition123</span></p>
             </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6 text-left">
            ...
            <div className="pt-2">
              <button 
                type="submit"
                className="w-full bg-[#1e293b] text-white font-semibold py-4 rounded-xl shadow-lg shadow-slate-900/10 hover:bg-slate-800 transition-all transform hover:-translate-y-0.5 active:scale-[0.98]"
              >
                Sign In
              </button>
            </div>
          ...
          <p className="mt-8 text-center text-sm text-gray-500 font-medium">
            Don't have an account? <span className="text-[#d4a017] cursor-pointer hover:underline underline-offset-4">Sign up</span>
          </p>
        </div>
      </div>
    </div>
